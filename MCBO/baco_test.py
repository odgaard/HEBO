...
if __name__ == '__main__':
    ...
    bo_builder = BoBuilder(
        model_id='gp_to', acq_opt_id='is', acq_func_id='ei', tr_id='basic', init_sampling_strategy="uniform"
    )

    optimizer = bo_builder.build_bo(search_space=search_space, input_constraints=task.input_constraints(),
